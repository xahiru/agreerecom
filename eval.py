...
print('User-based TCF RMSE: ' + str(rmse(tcf_user_prediction, test)) + '|' + ' User-based TCF AE: ' + str(ae(tcf_user_prediction, test)) + '|' + ' User-based TCF MAE: ' + str(mae(tcf_user_prediction, test)))
print('Item-based TCF RMSE: ' + str(rmse(tcf_item_prediction, test)) + '|' + ' Item-based TCF AE: ' + str(ae(tcf_item_prediction, test)) + '|' + ' Item-based TCF MAE: ' + str(mae(tcf_item_prediction, test)))
...
print('User-based TCF_Sim RMSE: ' + str(rmse(combined_user_prediction, test)) + '|' + ' User-based TCF_Sim AE: ' + str(ae(combined_user_prediction, test)) + '|' + ' User-based TCF_Sim MAE: ' + str(mae(combined_user_prediction, test)))
print('Item-based TCF_Sim RMSE: ' + str(rmse(combined_item_prediction, test)) + '|' + ' Item-based TCF_Sim AE: ' + str(ae(combined_item_prediction, test)) + '|' + ' Item-based TCF_Sim MAE: ' + str(mae(combined_item_prediction, test)))
